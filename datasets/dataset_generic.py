...
class Generic_WSI_Classification_Dataset(Dataset):
	def __init__(self,
		...
		if multi_site:
			label_dict = self.init_multi_site_label_dict(slide_data, label_dict, site_col)
	...
	@staticmethod
	def init_multi_site_label_dict(slide_data, label_dict, site_col='site'):
		print('initiating multi-source label dictionary')
		sites = slide_data[site_col].unique()
		multi_site_dict = {}
	...
	@staticmethod
	def df_prep(data, label_dict, ignore, label_col, multi_site=False, site_col=None, filter_dict={}):
		if label_col != 'label':
...
class Generic_MIL_Dataset(Generic_WSI_Classification_Dataset):
	...
	def __getitem__(self, idx):
		...
		if type(self.data_dir) == dict:
			source = self.slide_data['data_source'][idx]
